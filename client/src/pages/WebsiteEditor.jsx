...
import { ArrowLeft, Code2, MessageSquare, Monitor, Rocket, X } from 'lucide-react';
...
function WebsiteEditor() {
    ...
    const handleDeploy = async () => {
        try {
            ...
            setWebsite((previouWebsite) => ({ ...previouWebsite, deployed: true, deployUrl: result.data.url }));
        } catch (error) {
            console.log(error);
