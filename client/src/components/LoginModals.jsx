...
function LoginModals({ open, onClose }) {
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className='absolute -bottom-32 -right-32 w-80 h-80 bg-blue-500/30 
                                blur-[140px]'
                            />
                            ...
                            <div className='relative px-8 pt-14 pb-10 text-center'>
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.96 }}
                                    className='group relative w-full h-12 mt-4 rounded-xl bg-white text-black font-semibold
                                    shadow-xl overflow-hidden cursor-pointer'
                                    onClick={handleGoogleAuth}
                                >
                                    <div className='relative flex items-center justify-center gap-3 h-full'>
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/3840px-Google_%22G%22_logo.svg.png?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail" alt="Google image"
                                            className='w-5 h-5'
                                        />
